...
handleSubmit(event) {
console.log("some thing",this.state.value);
...
< label className = "col-md-8 control-label" htmlFor = "Upload photo" accept = ".jpg, .jpeg ,.png" > </label>
    ...
    <div className="col-xs-6 col-md-4 ">
        <div className="col-8 ">
            ...
            <form className="form-horizontal" onSubmit={this.state.value} >
                <fieldset>
              {/* <form> */}
                <p><label></label><input className="form-control" name="firstName"  placeholder="First Name"  value={this.value} onChange={this.handleChange}/></p>
                <p><label></label><input className ="form-control" name="lastName" placeholder ="Last Name" value={this.value} onChange={this.handleChange}/></p>
                ...
                <p><label></label><input className="form-control" name="address1"  placeholder="Address Line 1" value={this.value} onChange={this.handleChange}/></p>
                 ...
                 <label className="text">PAYMENT METHOD</label>
             ...
             <div className="text-center">
                <Button className="btn-red mr-4 " link="" name="Submit" type="submit"value="submit" />
             </div>
        {/* </form> */}
    </fieldset>
            </form>
